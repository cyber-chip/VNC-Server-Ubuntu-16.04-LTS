...
Есть еще 2 ой вариант как зайти удаленно опятьже на https://www.vultr.com/?ref=7489180 после поднятия сервера есть кнопка View Console 
при нажатии на ней поподаете на свой сервер предварительно установив графическую оболочку, а затем  
Все Удачи!
